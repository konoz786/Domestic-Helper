...
<head>
    ...
    <link rel="stylesheet" href="employer-history-nav.css?v=<?php echo time(); ?>">
    ...
    <style>
      body{
        background:url("photos/history.jpg");
...
<div id="helpers-card-container">
   ...
   <?php
        ...
        $sql="SELECT * 
        FROM complete_service_t AS c, domestic_helper AS dh
        WHERE dh.helper_id=c.helper_id AND c.customer_id='$employer_id'";
     ...
     <div class="row g-0">
       ...
       <div class="col-md-8">
         <div class="card-body">
           ...
           <p class="status">Status - <span>Work Completed!</span></p>
