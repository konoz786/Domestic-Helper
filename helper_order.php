...
<div id="helpers-card-container">
   ...
   <?php
        ...
        $sql="SELECT * 
        FROM order_t AS o, employer_t AS e
        WHERE o.customer_id=e.employer_id AND o.helper_id='$helper_id'";
     ...
     <div class="row g-0">
       ...
       <div class="col-md-8">
         <div class="card-body">
           ...
           <p class="status">Status - <span>Active Employer!</span></p>
           <a class="btn-container" href="service_end_config.php?employer_id='.$employer_id.'"><button class="service-complete-btn"><i class="fa-solid fa-check"></i> Service Completed</button></a>
